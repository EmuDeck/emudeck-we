...
function SRM_init(){
	...
	copyFromTo "$USERHOME\EmuDeck\backend\configs\steam-rom-manager" tools\
	...
	createLink "$emulationPath\tools\srm.exe" "$USERHOME\Desktop\EmuDeck - Steam Rom Manager.lnk"		
}
function SRM_update(){
	echo "NYI"
}

...
function Azahar_install(){
	...
	$url_azahar = getLatestReleaseURLGH "Azahar/azahar-archive" "zip" "windows-msvc"
	#$url_azahar = "https://github.com/Azahar/Azahar/releases/download/2118/azahar-2118-windows-msvc.zip"

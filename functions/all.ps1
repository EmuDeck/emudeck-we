...
. "$env:USERPROFILE\AppData\Roaming\EmuDeck\backend\functions\EmuScripts\emuDeckFlycast.ps1"
. "$env:USERPROFILE\AppData\Roaming\EmuDeck\backend\functions\EmuScripts\emuDeckSuperModel.ps1"
. "$env:USERPROFILE\AppData\Roaming\EmuDeck\backend\functions\EmuScripts\emuDeckScummVM.ps1"

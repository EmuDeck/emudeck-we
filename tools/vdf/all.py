...
latest_userid = get_latest_userid()
...
exe_path = r"C:\ruta\al\ejecutable\mi_juego.exe"
appname = "A3"
game_id = generate_shortcut_id(exe_path, appname)
artwork_path = r"C:\esde_p.png"  # Ruta a la imagen que deseas usar
icon_path = r"C:\esde_icon.png"
...
add_shortcut_if_not_exists(
    ...
    appname=appname,
    exe_path=exe_path,
    startdir=r"C:\ruta\al\ejecutable",
    icon=rf"{icon_path}"
)
...
#remove_shortcut(filepath=filepath, appname="A3")
# Ejemplo de uso
